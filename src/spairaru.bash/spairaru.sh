	...
	__gtCpntLdrx() {
		...
		do
			...
			do
				...
				[[ -z "${__s_cpnt_rprmtx__[$_ky]}" ]] \
				&& continue \
				;


				__gtCpntLdrx \
					${__s_cpnt_rprmtx__[$_ky]} \
				;
