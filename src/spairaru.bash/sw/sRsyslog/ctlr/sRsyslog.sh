...
# ======================================================================================
	RmtSysLogCtlr__optmz() {
		...
		# [ global_profile_document_linebreak ]
		local _glo_prfl_doc_lnbrk="` \
			s_gtDocLnBrkChr \
				"$_glo_prfl_fl_abs_pf" \
		`" ;
		...
		RmtSysLogPrflCtlr \
			fltr \
				...
				--mk_fl \
				\
				--aft '# DAEMON'"$_glo_prfl_doc_lnbrk" \
			\
			--vbo_ttl "daemon.*" \
			--pf "$_glo_prfl_fl_abs_pf" \
		;
		...
		RmtSysLogPrflCtlr \
			fltr \
				...
				--prio "info" \
				--mk_fl \
				--aft 'mail\.err.*'"$_glo_prfl_doc_lnbrk" \
			--vbo_ttl "mail.info" \
			--pf "$_glo_prfl_fl_abs_pf" \
		;
		...
		RmtSysLogPrflCtlr \
			fltr \
				...
				--prio "warn" \
				--mk_fl \
				--aft 'mail\.info.*'"$_glo_prfl_doc_lnbrk" \
			--vbo_ttl "mail.warn" \
			--pf "$_glo_prfl_fl_abs_pf" \
		;
